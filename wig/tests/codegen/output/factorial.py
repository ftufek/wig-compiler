...
def __save_global_vars():
	global_vars_file = "GLOBAL_715b9508-556c-4198-80c1-26bafecd5ec4"
...
def __logic_fn_factorial_6():
	...
	print "\n\n\n-------------"; print __vars; print ""; traceback.print_stack()
	global __vars
	__vars["10e6dbe6-7218-481b-8552-2cbc6301b59a"] = copy.deepcopy(__vars)
	__logic_fn_factorial_1(__vars["n_9_8"] - 1)
	return_val = __vars["__return_value"]
	call_stack = __vars["__call_stack"]
	__vars = __vars["10e6dbe6-7218-481b-8552-2cbc6301b59a"]
...
def __logic_fn_factorial_7():
	...
	if __returned_from_fn:
		__returned_from_fn = False
		__vars["cdb29234-b69d-4748-9062-d293065b1158"] = __vars["__return_value"]
		__set_fn_logic(8)
...
def __logic_fn_factorial_8():
	...
	global __next_logic
	print "\n\n\n-------------"; print __vars; print ""; traceback.print_stack()
	__return_from_fn(__vars["n_9_8"] * __vars["cdb29234-b69d-4748-9062-d293065b1158"])
...
def __logic_session_Test_1():
	...
	global __next_logic
	global __vars
	__vars["520e8d62-7eeb-4001-87d4-39502b0af894"] = copy.deepcopy(__vars)
	__logic_fn_factorial_1(10)
	return_val = __vars["__return_value"]
	call_stack = __vars["__call_stack"]
	__vars = __vars["520e8d62-7eeb-4001-87d4-39502b0af894"]
	__vars["__return_value"] = return_val
	__vars["__call_stack"] = call_stack
	__next_logic = 2
	__save_session_Test()
...
def __logic_session_Test_2():
	...
	if __returned_from_fn:
		__returned_from_fn = False
		__vars["0a7529c4-8a96-4b0b-810c-ad1ed3df0c74"] = __vars["__return_value"]
		__next_logic = 3
		__save_session_Test()
...
def __logic_session_Test_3():
	global __vars
	global __next_logic
	__vars["n_21_12"] = __vars["0a7529c4-8a96-4b0b-810c-ad1ed3df0c74"]
	__next_logic = 4
	__save_session_Test()
